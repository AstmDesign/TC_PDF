<?php
// TCPDF configuration
require_once(dirname(__FILE__).'/include/autoconfig.php');
// TCPDF static font methods and data
require_once(dirname(__FILE__).'/include/font_data.php');
// TCPDF static font methods and data
require_once(dirname(__FILE__).'/include/fonts.php');
// TCPDF static color methods and data
require_once(dirname(__FILE__).'/include/colors.php');
// TCPDF static image methods and data
require_once(dirname(__FILE__).'/include/images.php');
// TCPDF static methods and data
require_once(dirname(__FILE__).'/include/static.php');
